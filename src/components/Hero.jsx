...
const Hero = () => {
  ...
  return (
    <div className='z-10 mt-[250px] mb-[250px] flex justify-evenly'>

      <div className='text-start max-w-[490px]'>
        <h2 className='text-2xl ml-1 text-[#D4B783] font-[family-name:var(--font-kosugi)] '>Hi I'm</h2>
        <div className=' text-8xl font-extrabold flex-col text-start'>
          <h1>MUNEEB</h1>
          <h1 className='bg-linear-to-r from-[#D4B783] to-[#A08C64] bg-clip-text text-transparent'>MOOSA</h1>
        </div>

        <p className='font-[family-name:var(--font-kosugi)] text-[#9CA3AF] mt-[40px]'>
        ...
        <div className="flex gap-6 mt-8">
          {[FaGithub, FaLinkedinIn, FaInstagram, FaWhatsapp, FaDiscord].map((Icon, i) => (
            <div key={i} className="w-10 h-10 flex items-center justify-center rounded-full border border-white/20 text-gray-400 hover:text-[#D4B783] hover:border-[#D4B783] transition cursor-pointer">
              <Icon />
            </div>
          ))}
        </div>
      ...
      <div className="relative w-[360px] h-[360px] mt-15 flex items-center justify-center overflow-visible">
        {/* SVG (fixed) */}
        <motion.svg
          className="orbit-svg"
